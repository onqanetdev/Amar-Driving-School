...
class InstructorTermsConditionsModel {
  ...
  InstructorTermsConditionsModel({
  ...
  factory InstructorTermsConditionsModel.fromJson(
    ...
    return InstructorTermsConditionsModel(
      ...
      data: TermsConditionsData.fromJson(
        json['data'],
      ),
    );
  }
...
class TermsConditionsData {
  ...
  factory TermsConditionsData.fromJson(
      Map<String, dynamic> json) {
